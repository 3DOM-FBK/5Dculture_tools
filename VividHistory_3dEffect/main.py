...
def parseArguments():
    ...
    parser.add_argument('--process',
                        type=str,
                        default='None',
                        help='Specify Process [europeana or 3dEffect]')
    ...
    parser.add_argument('--input',
                        type=str,
                        default='None',
                        help='Input image - Only for effect_3d process')
    
    parser.add_argument('--effect_3d',
                        type=str,
                        default='dolly-zoom-in',
                        help='Specify 3D effect ["dolly-zoom-in", "zoom-in", "circle", "swing"] - Only for effect_3d process')
...
if __name__ == "__main__":
    ...
    elif ('effect_3d' in args.process.lower()):
        os.system('python /3d-photo-inpainting/3dEffect.py --input '+str(args.input)+' --output '+str(args.outDir)+' --effect_3d '+str(args.effect_3d)+' --wsl '+str(args.wsl))
    else:
        sys.exit('Eroor - process must be "europeana" or "3dEffect"')
